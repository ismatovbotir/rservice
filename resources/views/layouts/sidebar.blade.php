                ...
                <ul class="nk-menu">
                    <li class="nk-menu-item">
                        <a href="{{route('main')}}" class="nk-menu-link">
                            ...
                            <span class="nk-menu-text">Asosiy</span>
                        </a>
                    </li><!-- .nk-menu-item -->
                    <li class="nk-menu-item">
                    ...
                    <li class="nk-menu-item">
                        <a href="" class="nk-menu-link">
                            ...
                            <span class="nk-menu-text">OFD</span>
                        </a>
                    </li><!-- .nk-menu-item -->
                    <li class="nk-menu-item">
                        <a href="" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-chat"></em></span>
                            <span class="nk-menu-text">Murojaatlar</span>
                        </a>
                    </li><!-- .nk-menu-item -->
                    <li class="nk-menu-item">
                        <a href="" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-setting"></em></span>
                            <span class="nk-menu-text">Uskunalar</span>
                        </a>
                    </li><!-- .nk-menu-item -->
                    ...
                    <li class="nk-menu-item">
                        <a href="#" class="nk-menu-link">
                            ...
                            <span class="nk-menu-text">POS uskunalar</span>
                        </a>
